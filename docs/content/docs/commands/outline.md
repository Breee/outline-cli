---
title: "outline"
description: "CLI reference for outline"
llmsDescription: "Auto-generated CLI reference for outline. Contains usage, flags, and examples."
generated: true
---

## outline

Push markdown documents to Outline

### Synopsis

A modern CLI for pushing markdown files to an Outline wiki.
