...
- [Authentication options](auth.md) — OIDC, API token, or basic auth
- [Metadata headers](metadata.md) — control title, collection, icon per file
- [CI/CD integration](cicd.md) — automate on every git push
