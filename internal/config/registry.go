...
type Option struct {
	...
	AltEnvVar   string // alternative env var (e.g. "OUTLINE_HOST" as alias)
...
var Registry = []Option{
	{Key: "server_url", EnvVar: "OUTLINE_SERVER_URL", AltEnvVar: "OUTLINE_HOST", Description: "Outline server base URL"},
	{Key: "auth_method", EnvVar: "OUTLINE_AUTH_METHOD", Description: "Auth method: api_token, oidc, basic"},
	{Key: "token_storage", Description: "Secret storage backend: keyring, file"},
	{Key: "oidc_port", Description: "Local port for OIDC callback"},
